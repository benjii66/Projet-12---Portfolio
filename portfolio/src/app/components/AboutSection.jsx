    ...
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          I am a junior web developer with a passion for crafting interactive and responsive web applications. My journey into web development began with a background in gameplay programming from my time in a game development school, where I gained proficiency in C# and C++.
          ...
          Outside of coding, I am an avid rock climber, finding joy in the challenge and problem-solving aspect of the sport.
          I am excited about the prospect of joining an apprenticeship in React in the future. As a team player, I thrive in collaborative environments and am eager to contribute my skills and creativity to building amazing applications alongside like-minded professionals.
          </p>
